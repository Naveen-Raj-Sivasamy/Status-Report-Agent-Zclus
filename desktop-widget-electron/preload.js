...
contextBridge.exposeInMainWorld('statusApp', {
  ...
  getDataSourceTypes: () => ipcRenderer.invoke('get-data-source-types'),
  getDataSources: () => ipcRenderer.invoke('get-data-sources'),
  saveDataSources: (dataSources) => ipcRenderer.invoke('save-data-sources', dataSources),
  ...
  cleanupWeeklyConnectAndLeaveTabs: () => ipcRenderer.invoke('cleanup-weekly-connect-and-leave-tabs'),
